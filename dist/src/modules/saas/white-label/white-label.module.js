...
const white_label_controller_1 = require("./controllers/white-label/white-label.controller");
...
exports.WhiteLabelModule = WhiteLabelModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [white_label_service_1.WhiteLabelService],
        controllers: [white_label_controller_1.WhiteLabelController],
