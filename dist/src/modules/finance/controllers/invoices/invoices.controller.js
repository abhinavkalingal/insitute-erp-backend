...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all invoices with pagination' }),
    (0, api_paginated_response_decorator_1.ApiPaginatedResponse)(invoice_dto_1.CreateInvoiceDto),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [invoice_dto_1.InvoiceQueryOptionsDto]),
    __metadata("design:returntype", void 0)
], InvoicesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('read:finance'),
    (0, swagger_1.ApiOperation)({ summary: 'Get invoice by ID (includes items & payments)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update an invoice (status or discount)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete an invoice permanently' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
exports.InvoicesController = InvoicesController = __decorate([
    (0, swagger_1.ApiTags)('Finance / Invoices'),
