...
exports.FeeDiscountsService = void 0;
...
let FeeDiscountsService = class FeeDiscountsService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findAll(queryOptions) {
        ...
        return new page_dto_1.PageDto(discounts, pageMetaDto);
    }
    async findOne(id) {
...
exports.FeeDiscountsService = FeeDiscountsService;
exports.FeeDiscountsService = FeeDiscountsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], FeeDiscountsService);
//# sourceMappingURL=fee-discounts.service.js.map