...
__decorate([
    ...
    (0, api_paginated_response_decorator_1.ApiPaginatedResponse)(expense_category_dto_1.CreateExpenseCategoryDto),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [expense_category_dto_1.ExpenseCategoryQueryOptionsDto]),
    __metadata("design:returntype", void 0)
], ExpenseCategoriesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('read:finance'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a specific expense category by ID' }),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, expense_category_dto_1.UpdateExpenseCategoryDto]),
    __metadata("design:returntype", void 0)
], ExpenseCategoriesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('delete:finance'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete an expense category' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
exports.ExpenseCategoriesController = ExpenseCategoriesController = __decorate([
    (0, swagger_1.ApiTags)('Finance / Expense Categories'),
