...
exports.RoomQueryOptionsDto = exports.UpdateRoomDto = exports.CreateRoomDto = void 0;
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateRoomDto.prototype, "branchId", void 0);
__decorate([
...
class RoomQueryOptionsDto extends page_options_dto_1.PageOptionsDto {
    branchId;
}
exports.RoomQueryOptionsDto = RoomQueryOptionsDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by branch ID' }),
    (0, class_validator_1.IsUUID)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], RoomQueryOptionsDto.prototype, "branchId", void 0);
