...
const prisma_master_service_1 = require("./src/infrastructure/database/prisma-master.service");
async function bootstrap() {
    ...
    const prismaMaster = app.get(prisma_master_service_1.PrismaMasterService);
